...
# boxplot.matrix2.R
#
# Extended boxplot utility for visualizing QC metric distributions.
# Used by sigsQcNegativeControl to create comparison boxplots overlaying the
# null distribution (negative or permutation controls) with the original
# signature's metric values as scatter points.
#
# PDF sizing adapts to the number of metrics: <=25 elements → 7" wide,
# 25-50 → 10", 50-75 → 14", >75 → 18". These are magic numbers.
#
# Also provides .areColours() and .areAllColours() helper functions
# to validate color specifications before plotting.
#
